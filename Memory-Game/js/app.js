...
var match_found = 0;
/*
 * Create a card list that holds all of your cards
 */
...
// flag to check when first card opened
var game_started = false;

// reference to reset button to reset the game
...
// creating array to keep track of the open cards
openCards = [];
...
// check the openCards if they match or not
...
// function animateCss to add animations
$.fn.extend({
